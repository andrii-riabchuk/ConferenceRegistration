...
namespace ConferenceRegistration.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ParticipantManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<ParticipantManager>();
            }
            private set
            {
                _userManager = value;
        ...
        public ActionResult Register()
        {
            ...
            {
                var model = new RegisterViewModel { Regions = dbContext.Regions.ToList()};
                return View(model);
            }
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new Participant
                {
                    ...
                    RegionId = Convert.ToInt32(model.RegionId),
            ...
            // Validation will take you only so far
            using (var dbContext = new ApplicationDbContext())
            {
                model.Regions = dbContext.Regions.ToList();
                return View(model);
            }
        }
